      ...
      <div className='p-6'>
        ...
        <div className='flex justify-center gap-4 text-gray-500 mb-4'>
          <p>
            ...
            <span className='md:hidden lg:inline'>Fuel Type</span>
          </p>
          <p>
            <FaCogs className='inline-block mr-2' /> {car.transmission}{' '}
            <span className='md:hidden lg:inline'>Transmission</span>
          </p>
          <p>
            <FaCalendarAlt className='inline-block mr-2' />
            {car.year}{' '}
            <span className='md:hidden lg:inline'>Year</span>
          </p>
        </div>
