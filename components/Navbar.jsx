            ...
            <div className="flex flex-1 items-center justify-center md:items-stretch md:justify-start">
              ...
              <div className="hidden md:ml-6 md:block">
                <div className="flex space-x-2">
                  ...
                  <Link
                    href="/cars"
                    className={`${pathname === "/cars" ? "bg-black" : ""}
                    text-white 
                     hover:text-white rounded-md px-3 py-2`}
                  >
                    Cars
                  ...
                  {session && (
                    <Link
                      href="/cars/add"
                      className={`${pathname === "/cars/add" ? "bg-black" : ""}
                text-white hover:bg-gray-700  hover:text-white block
                ...
                <div className="relative ml-3 ">
                  ...
                  {isProfileMenuOpen && (
                    <div
                      ...
                      className=" absolute 
                  right-0 z-10 
                  mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1
          ...
          <div id="mobile-menu">
            <div className="space-y-1 px-2 pb-3 pt-2">
              <Link
                href="/"
                className={`${pathname === "/" ? "bg-black" : ""}
                hover:bg-gray-700 text-gray-300 block rounded-md px-3 py-2 text-base font-medium`}
              >
                Home
              </Link>
              <Link
                href="/properties"
                className={`${pathname === "/properties" ? "bg-black" : ""}
                text-gray-300 hover:bg-gray-700 block rounded-md px-3 py-2 text-base font-medium`}
              >
                Properties
              </Link>
              <Link
