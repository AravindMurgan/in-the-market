...
In The Market uses the following technologies:
...
- Maptiler account. Sign up at [Mapbox](https://www.maptiler.com/)
...
- Get your Mapbox token from your Mapbox account and add it to `NEXT_PUBLIC_MAPTILER_API_KEY`.
